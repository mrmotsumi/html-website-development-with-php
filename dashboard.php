   ...
   if(mysqli_num_rows($result) > 0)
{
  ...
  <source src="<?php echo  $row["url"] ?>" type="video/mp4">
	...
	<button type="button"  name="like" class="btn btn-primary btn-xs like" id="<?php echo  $row["id"] ?>"><i class="fa fa-fa fa-thumbs-up" aria-hidden="true"></i></button>
	
		<button type="button"  name="favorite" class="btn btn-primary btn-xs favorite" id="<?php echo  $row["id"] ?>"><i class="fa fa-star" aria-hidden="true"></i></button>
