...
<html lang="en">
  ...
  <div class="main_content" >
   ...
   $query = "select * from event e, liked_videos w where e.id=w.video_id AND w. user_id='$user_id'";
	  ...
	  function Book_bus(id)
 {
  ...
  var remove_id = $(this).attr("id");
		 ...
		 swal({
			  ...
			  text: "this  video will be removed from your stared!",
			  icon: "success",
			  buttons: true,
			  dangerMode: true,
			})
			.then((willDelete) => {
			  if (willDelete) {
				...
				url: 'action.php',
				success: function(data) {
						swal("Proof! Video have been removed!!", {
										  icon: "success",
